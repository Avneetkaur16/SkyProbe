  ...
  return (
    <div className='payment-main'>
      <div className='payment-pricelist'>
        <h3>Flight</h3>
        <small>{seats} {seats === 1 ? `ticket` : `tickets`}</small>
        <hr></hr>
        ...
        <div className='payment-list'>
          {Array(seats).fill(true).map((item, index) => (
            <div className='payment-list-item' key={index}>
              ...
              <p>${category === "Business" ? selectedFlight?.business?.cost : selectedFlight?.economy?.cost}</p>
          </div>
          ))}
          <hr></hr>
          <br />
          ...
          <div className='payment-list-item'>
            ...
            <p style={{ fontWeight: '700' }}>${(category === "Business" ? selectedFlight?.business?.cost : selectedFlight?.economy?.cost) * seats}</p>
          </div>
        </div>
      </div>
      ...
      <div className='payment-travelers'>
        ...
        {Array(seats).fill(true).map((item, index) => (
          <form className='payment-traveler' key={index}>
            ...
            <button className='payment-save' type='submit' onClick={handleSave}>Save</button>
          </form>
        ))}
      </div>
