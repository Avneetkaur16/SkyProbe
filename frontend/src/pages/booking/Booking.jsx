        ...
        <div className='booking-container' ref={pdfRef}>
                ...
                <div className='booking-flight'>
                    ...
                    <div className='booking-flight-location'>
                        ...
                        <h4>Departure: </h4><p>Date: {flight?.origin?.date.slice(0, 10)}, Time: {flight?.origin?.time}</p>
                        <h4>Arrival: </h4><p>Date: {flight?.destination?.date.slice(0, 10)}, Time: {flight?.destination?.time}</p>
                    </div>
                </div>
